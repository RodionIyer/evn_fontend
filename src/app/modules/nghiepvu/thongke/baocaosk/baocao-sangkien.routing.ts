...
import { ApiInputDetailResolver, ApiInputListResolver } from './baocao-sangkien.resolvers';
...
export const BaoCaoSangKienRoutes: Route[] = [
  {
    path: '',
    component: BaoCaoSangKienComponent,
    children: [
      {
