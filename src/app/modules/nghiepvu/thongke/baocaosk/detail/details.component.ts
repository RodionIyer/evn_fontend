...
import {BaoCaoSangKienService} from '../baocao-sangkien.service';
...
export class DetailsComponent implements OnInit {
    ...
    public listDonViChuTri: any[] = [];
    public listCapQuanLy = [];
    public donViChuTri: any | null;
    public capQuanLy: any | null;
    public linhVucNghienCuu: any | null;
    public listLinhVucNghienCuu: any[] = [];
    public phanLoai: any | null;
    ...
    ngOnInit(): void {
        this.listDonViChuTri = [];
        this.listLinhVucNghienCuu = [];
        this.listCapQuanLy = [];
        this.geListYears();
    ...
    timKiem() {
        ...
        this._serviceApi.execServiceLogin("8EA6E3A8-860D-46A9-98B6-AD215E62FE45", [{
            "name": "LOAI_TIM_KIEM",
            "value": this.loaiTimKiem
    ...
    export() {
        ...
        this._serviceApi.execServiceLogin("812E1113-7206-43DA-B3FA-71509FEF209C", [{
            "name": "LOAI_TIM_KIEM",
            "value": this.loaiTimKiem
        }, {"name": "TIM_KIEM", "value": JSON.stringify(obj)}]).subscribe((data) => {
            this.downloadTempExcel(data.data, "THONG_KE.xlsx");
