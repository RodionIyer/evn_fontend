...
export class ApiInputListResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    constructor(
        private _listapiinputService: BaoCaoSangKienService,
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any[]> | any {
        ...
        sources.push(this._listapiinputService.getApiInputByAll());
            ...
            .pipe(
                finalize(() => {
                    ...
                    if (!currentRoute.paramMap.get('id')) {
                        // Reset the Api
                        this._listapiinputService.resetObject().subscribe();
                    }
                }),
...
export class ApiInputDetailResolver implements Resolve<any>
{
    /**
     * Constructor
     */
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> {
        ...
        if (route.paramMap.get('id')) {
            sources.push(this._listapiinputService.getObjectById(route.paramMap.get('id')));
        }
