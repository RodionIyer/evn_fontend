...
export class ApiDinhHuongListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.listYears.sort((a, b) => b.NAME - a.NAME);
    ...
    timKiem() {
        this.getDinhHuongSubcription = this._serviceApi.execServiceLogin("DEA672A5-4533-4C16-8D99-7E6D4D277941", [{
            "name": "MA_TRANG_THAI",
            "value": this.selectedStatus
        }, {"name": "NAM", "value": this.selectedYear}, {
            "name": "PAGE_NUM",
    ...
    xoa(item) {
        this._messageService.showConfirm("Thông báo", "Bạn chắc chắn muốn xóa \"" + item.name + "\"", (toast: SnotifyToast) => {
            ...
            this._serviceApi.execServiceLogin("CC1C9234-D950-4493-8189-1C65C07BE01C", [{
                "name": "MA_KE_HOACH",
                "value": item.maKeHoach
            }, {"name": "USERID", "value": "STR"}]).subscribe((data) => {
                console.log(data);
                switch (data.data) {
                    case 1:
