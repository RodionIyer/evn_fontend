...
export class PopupCbkhComponent implements OnInit {
    ...
    timkiemNguoi(type){
        ...
        this.getDinhHuongSubcription = this._serviceApi.execServiceLogin("395A68D9-587F-4603-9E1D-DCF1987517B4", [{"name":"TEN_NGUOI_THUC_HIEN"},{"name":"TIM_KIEM","value":JSON.stringify(obj)}]).subscribe((data) => {
            if(type=="CHUNHIEM"){
