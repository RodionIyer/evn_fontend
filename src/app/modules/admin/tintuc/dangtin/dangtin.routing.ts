...
import {
    DangTinDetailsResolve,
    DangTinResolver,
} from './dangtin.resolvers';
import { DangTinDetailsComponent } from './detail/details.component';
import { DangTinListComponent } from './list/list.component';
import { DangTinEmptyDetailsComponent } from './empty-details/empty-details.component';

export const DangTinRouteMatcher: (url: UrlSegment[]) => UrlMatchResult = (
    url: UrlSegment[]
) => {
...
export const DangTinRunGuardsAndResolvers: (
...
export const DangTinRoutes: Route[] = [
    {
        path: '',
        component: DangTinComponent,
        resolve: {
            groups: DangTinResolver,
        },
        children: [
            {
                component: DangTinListComponent,
                matcher: DangTinRouteMatcher,
                runGuardsAndResolvers: DangTinRunGuardsAndResolvers,
                children: [
                    {
                        path: '',
                        pathMatch: 'full',
                        component: DangTinEmptyDetailsComponent,
                    },
                    {
                        path: ':id',
                        component: DangTinDetailsComponent,
                        runGuardsAndResolvers: 'always',
                        resolve: {
                            obj: DangTinDetailsResolve,
                        },
                    },
                ],
            },
